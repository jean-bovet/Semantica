...
import { checkForParserUpgrades, migrateExistingFiles, shouldReindex, FileStatus } from '../../app/electron/worker/reindexManager';
import { PARSER_VERSIONS } from '../../app/electron/worker/parserVersions';
