...
export const STAGE_TIMEOUTS: StageTimeout[] = [
  ...
  { stage: StartupStage.SIDECAR_START, timeout: 10000 },
  { stage: StartupStage.SIDECAR_READY, timeout: 30000 }, // Can be slow with model loading
...
export function getStageDisplayName(stage: StartupStage): string {
  switch (stage) {
    ...
    case StartupStage.SIDECAR_START:
      return 'Starting Python sidecar';
    case StartupStage.SIDECAR_READY:
